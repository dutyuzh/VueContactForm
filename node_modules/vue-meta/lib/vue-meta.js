...
function getComponentOption (opts, result) {
  ...
  if (typeof $options[option] !== 'undefined' && $options[option] !== null) {
    ...
    if (isArray(data)) {
      result = data.reduce(function (result, dataItem) { return mergeDataInResult(dataItem, result, component, arrayMerge); }, result);
    } else {
...
function mergeDataInResult (data, result, component, arrayMerge) {
  ...
  if (typeof data === 'object') {
    ...
    return deepmerge_1(result, data, { arrayMerge: arrayMerge })
  }
  return data
}
